    ...
    >
      ...
      >
          <button
            ...
            onDoubleClick={() => (window.location.href = "/Service" )}
        >
          ...
          {activeDropdown === "services" && (
            ...
            <div ref={servicesDropdownRef} className="dropdown-content show">
              ...
              <button onClick={closeMobileMenu}>
                <Link href={"/Service"}>Tax Preparation</Link>
              </button>
              <button onClick={closeMobileMenu}>
                <Link href={"/Service"}>Payroll</Link>
              </button>
              <button onClick={closeMobileMenu}>
                <Link href={"/Service"}> General Accounting</Link>
              </button>
              <button onClick={closeMobileMenu}>
        ...
        >
          <button
            ...
            onDoubleClick={() => (window.location.href = "/Expertise" )}
          >
